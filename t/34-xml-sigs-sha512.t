...
Authen::NZRealMe->register_class(algorithm_sha512   => 'sha512');

my $algorithm      = 'sha512';
my $dsig_ns        = 'http://www.w3.org/2000/09/xmldsig#';
my $uri_exc_c14n   = 'http://www.w3.org/2001/10/xml-exc-c14n#';
my $uri_rsa_sha512 = 'http://www.w3.org/2001/04/xmldsig-more#rsa-sha512';
my $uri_env_sig    = 'http://www.w3.org/2000/09/xmldsig#enveloped-signature';
my $uri_sha512     = 'http://www.w3.org/2001/04/xmlenc#sha512';
...
isa_ok($signer->_algorithm, 'sha512', 'using pluggable sha512 algorithm');
...
is($sig_method, $uri_rsa_sha512, 'signature method from SignedInfo');

my $sig_algorithm = Authen::NZRealMe->new_algorithm_from_SignatureMethod($sig_method);
isa_ok($sig_algorithm, 'sha512', 'Plugin algorithm class from SignatureMethod');
...
is($digest_method, $uri_sha512, 'digest method matches known URI');

my $digest_algorithm = Authen::NZRealMe->new_algorithm_from_DigestMethod($digest_method);
isa_ok($digest_algorithm, 'sha512', 'Plugin algorithm class from DigestMethod');
